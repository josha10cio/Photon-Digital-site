...
export const metadata: Metadata = {
  ...
  description: "Frequently asked questions about Photon Echo's Physical AI infrastructure and services.",
}
      ...
      <section className="relative w-full py-20 md:py-32 lg:py-48 bg-photon-gradient-hero text-white overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl leading-tight mb-8 animate-fadeIn">FAQ</h1>

...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about Photon Design & Engineering, our founder's vision, team expertise, and commitment to delivering exceptional design and engineering solutions.",
}
  ...
  return (
    <div className="flex flex-col min-h-[calc(100dvh-4rem)]">
      ...
      <section className="w-full py-16 md:py-24 bg-photon-900 text-white relative z-10">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12 animate-fadeIn" style={{ animationDelay: "0.4s" }}>
            <h2 className="section-title">Expert Team & Background</h2>
            <p className="mt-4 text-lg text-photon-200 max-w-2xl mx-auto">
              Our team brings together decades of experience from leading technology companies and engineering firms.
            </p>
          </div>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <div
              className="flex flex-col items-center text-center group glassmorphism p-4 shadow-inner-bevel card-lift-on-hover relative z-10 animate-fadeIn"
            ...
            >
              <Image
                ...
                width={200}
                height={200}
                alt="Team Member: Dr. Alex Rivera"
                className="rounded-full object-cover w-40 h-40 mb-4 border-4 border-photon-700 filter blur-[1px] group-hover:border-photon-500 transition-colors"
              />
              <h3 className="text-xl font-semibold text-white">Dr. Alex Rivera</h3>
              <p className="text-photon-300">Chief Engineering Officer</p>
              <p className="text-sm text-photon-200 mt-2">20+ years at Boeing and Lockheed Martin. PhD Mechanical Engineering, MIT.</p>
            </div>
            <div
              className="flex flex-col items-center text-center group glassmorphism p-4 shadow-inner-bevel card-lift-on-hover relative z-10 animate-fadeIn"
            ...
            >
              <Image
                ...
                className="rounded-full object-cover w-40 h-40 mb-4 border-4 border-photon-700 filter blur-[1px] group-hover:border-photon-500 transition-colors"
              />
              <h3 className="text-xl font-semibold text-white">Sarah Lee</h3>
              <p className="text-photon-300">Creative Director</p>
              <p className="text-sm text-photon-200 mt-2">Former Apple and Google design lead. 15+ years in product design and UX.</p>
            </div>
            <div
              className="flex flex-col items-center text-center group glassmorphism p-4 shadow-inner-bevel card-lift-on-hover relative z-10 animate-fadeIn"
            ...
            >
              ...
              <p className="text-photon-300">Technical Operations Director</p>
              <p className="text-sm text-photon-200 mt-2">Former Tesla and SpaceX manufacturing engineer. Expert in production optimization.</p>
            </div>
            <div
              className="flex flex-col items-center text-center group glassmorphism p-4 shadow-inner-bevel card-lift-on-hover relative z-10 animate-fadeIn"
            ...
            >
              <Image
                ...
                width={200}
                height={200}
                alt="Team Member: Jessica Kim"
                className="rounded-full object-cover w-40 h-40 mb-4 border-4 border-photon-700 filter blur-[1px] group-hover:border-photon-500 transition-colors"
              />
              <h3 className="text-xl font-semibold text-white">Jessica Kim</h3>
              <p className="text-photon-300">Government Programs Director</p>
              <p className="text-sm text-photon-200 mt-2">Former Defense contractor with Secret clearance. Expert in compliance and documentation.</p>
            </div>
          </div>
        </div>
      </section>
